        ...
        <x-form method="post" :route="route('tool.handle', $tool->slug)">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="input-group{{ $errors->has('video_url')? ' is-invalid' : '' }}">
                        <x-text-input class="form-control" name="video_url" id="video_url" type="url" required
                            value="{{ $results->video_url ?? old('video_url') }}" :placeholder="__('tools.enterVideoUrl')" :error="$errors->has('video_url')" />
